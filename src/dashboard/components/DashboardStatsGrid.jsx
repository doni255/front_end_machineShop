...
function DashboardStatsGrid() {
  ...
  useEffect(() => {
    const fetchTotalUsers = async () => {
      try {
        const response = await fetch("https://backendtokomesin.grhapengharapan.org/api/total-users");
  ...
  useEffect(() => {
    const fetchTotalStock = async () => {
      try {
        const response = await fetch("https://backendtokomesin.grhapengharapan.org/api/total-stock");
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchTotalTambahStock = async () => {
      try {
        const response = await fetch("https://backendtokomesin.grhapengharapan.org/api/tambah_stock/");
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchTotalUang = async () => {
      try {
        const response = await fetch("https://backendtokomesin.grhapengharapan.org/api/uang");
        const data = await response.json();
